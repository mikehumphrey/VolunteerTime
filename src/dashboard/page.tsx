    ...
    <div className="flex flex-col items-center justify-center h-full w-full">
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-headline flex items-center justify-center gap-2 uppercase">
        ...
        <CardContent className="flex flex-col items-center gap-6 p-8">
          ...
          <Button 
            size="lg" 
            className={`w-full h-16 text-xl rounded-full transition-all duration-300 transform hover:scale-105 ${isClockedIn ? 'bg-destructive hover:bg-destructive/90' : 'bg-primary text-primary-foreground'}`}
